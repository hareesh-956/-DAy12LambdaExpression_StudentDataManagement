namespace DAy12LambdaExpression_StudentDataManagement
{
    ...
    class Program
    {
        ...
        {
            new Student { Id = 1, Name = "hari", PhoneNumber = "1234567890", Address = "123 Main St", Age = 15 },
            new Student { Id = 2, Name = "ugesh", PhoneNumber = "9876543210", Address = "456 Elm St", Age = 18 },
            new Student { Id = 3, Name = "ram", PhoneNumber = "5556667777", Address = "789 Oak St", Age = 20 },
            new Student { Id = 4, Name = "sai", PhoneNumber = "9991112222", Address = "123 Main St", Age = 14 },
        };
